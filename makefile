...
feed: frontend/feed.o frontend/view/feed_view.o frontend/controllers/manager_handler_thread.o frontend/controllers/monitor_server_thread.o frontend/display/topic_display.o utils/globals.o
	gcc -o frontend/feed frontend/feed.o frontend/view/feed_view.o frontend/controllers/manager_handler_thread.o frontend/controllers/monitor_server_thread.o  frontend/display/topic_display.o utils/globals.o
